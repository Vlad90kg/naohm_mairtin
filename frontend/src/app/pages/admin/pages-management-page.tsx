...
import { 
  ...
  updateTeamsPageContent, 
  fetchFixturesPageContent, 
  updateFixturesPageContent,
  type ApiTeamsPageContent,
  type ApiFixturesPageContent
...
export function PagesManagementPage() {
  ...
  const [teamsPageData, setTeamsPageData] = useState<ApiTeamsPageContent | null>(null);
  const [fixturesPageData, setFixturesPageData] = useState<ApiFixturesPageContent | null>(null);
  
  const [activeTab, setActiveTab] = useState<'Home' | 'Contact' | 'Child Safety' | 'Facilities' | 'Teams' | 'Fixtures'>('Home');
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (activeTab === 'Teams' && teamsPageData) {
        await updateTeamsPageContent(teamsPageData);
      }
      
      if (activeTab === 'Fixtures' && fixturesPageData) {
        await updateFixturesPageContent(fixturesPageData);
      }
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-grow">
          {isLoading ? (
            <div className="bg-white p-20 rounded-[3rem] border border-gray-100 flex justify-center">
            ...
            <form onSubmit={handleSave} className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm space-y-10">
              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-right-2 duration-300">
                {activeTab === 'Home' && (
                  ...
                  <HomeFormFields formData={formData} setFormData={setFormData} />
                )}

                {activeTab === 'Teams' && teamsPageData && (
                  <div className="space-y-10">
                    <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            value={teamsPageData.hero_title}
                            onChange={(e) => setTeamsPageData({...teamsPageData, hero_title: e.target.value})}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-black text-[#1E3A8A] outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Hero Subtitle</label>
                          <textarea
                            value={teamsPageData.hero_subtitle}
                            onChange={(e) => setTeamsPageData({...teamsPageData, hero_subtitle: e.target.value})}
                            rows={3}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-medium text-gray-600 outline-none"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
                      ...
                      <div className="grid gap-4">
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Eyebrow</label>
                          <input
                            type="text"
                            value={teamsPageData.hub_eyebrow}
                            onChange={(e) => setTeamsPageData({...teamsPageData, hub_eyebrow: e.target.value})}
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            value={teamsPageData.hub_title}
                            onChange={(e) => setTeamsPageData({...teamsPageData, hub_title: e.target.value})}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <textarea
                            value={teamsPageData.hub_description}
                            onChange={(e) => setTeamsPageData({...teamsPageData, hub_description: e.target.value})}
                            rows={3}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-medium outline-none"
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
                      ...
                      <div className="grid gap-4">
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            value={teamsPageData.gallery_eyebrow}
                            onChange={(e) => setTeamsPageData({...teamsPageData, gallery_eyebrow: e.target.value})}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            value={teamsPageData.gallery_title}
                            onChange={(e) => setTeamsPageData({...teamsPageData, gallery_title: e.target.value})}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Description</label>
                          <textarea
                            value={teamsPageData.gallery_description}
                            onChange={(e) => setTeamsPageData({...teamsPageData, gallery_description: e.target.value})}
                            rows={3}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-medium outline-none"
                          />
                        </div>
                ...
                {activeTab === 'Fixtures' && fixturesPageData && (
                  <div className="space-y-10">
                    <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
                      <h4 className="text-sm font-black text-[#1E3A8A] uppercase tracking-widest flex items-center gap-2">
                        Hero Section
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <input
                            type="text"
                            value={fixturesPageData.hero_title}
                            onChange={(e) => setFixturesPageData({...fixturesPageData, hero_title: e.target.value})}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-black text-[#1E3A8A] outline-none"
                          />
                        </div>
                        <div className="space-y-2">
                          <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Hero Subtitle</label>
                          <textarea
                            value={fixturesPageData.hero_subtitle}
                            onChange={(e) => setFixturesPageData({...fixturesPageData, hero_subtitle: e.target.value})}
                            rows={3}
                            className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl font-medium text-gray-600 outline-none"
                          />
                        </div>
                ...
                {activeTab === 'Child Safety' && (
                  <ChildSafetyFormFields formData={formData} setFormData={setFormData} />
                )}

                {activeTab === 'Facilities' && (
                  <FacilitiesFormFields formData={formData} setFormData={setFormData} />
                )}
              </div>
            </form>
          )}
...
function HomeFormFields({ formData, setFormData }: any) {
  return (
    <div className="space-y-10">
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
        <h4 className="text-sm font-black text-[#1E3A8A] uppercase tracking-widest flex items-center gap-2">
...
function ContactFormFields({ formData, setFormData }: any) {
  return (
...
function ChildSafetyFormFields({ formData, setFormData }: any) {
  return (
    <div className="space-y-12">
      ...
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-8">
        ...
        <div className="space-y-6">
          {formData.childSafety.contacts.map((contact: any, idx: number) => (
            <div key={contact.id} className="p-6 bg-gray-50 rounded-3xl border border-gray-100 space-y-6 relative group/item">
              <button 
                type="button"
                onClick={() => {
                  const updated = formData.childSafety.contacts.filter((_: any, i: number) => i !== idx);
                  setFormData({...formData, childSafety: {...formData.childSafety, contacts: updated}});
                }}
      ...
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-8">
        ...
        <div className="space-y-4">
          {formData.childSafety.documents.map((doc: any, idx: number) => (
            <div key={doc.id} className="p-6 bg-gray-50 rounded-2xl border border-gray-100 flex flex-col sm:flex-row items-end gap-6 relative">
              <button 
                type="button"
                onClick={() => {
                  const updated = formData.childSafety.documents.filter((_: any, i: number) => i !== idx);
                  setFormData({...formData, childSafety: {...formData.childSafety, documents: updated}});
                }}
                className="absolute top-4 right-4 text-red-300 hover:text-red-500 transition-colors"
              >
      ...
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {formData.childSafety.steps.map((step: any, idx: number) => (
      ...
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {formData.childSafety.helplines.map((line: any, idx: number) => (
            <div key={idx} className="p-4 bg-gray-50 rounded-2xl border border-gray-100 relative group">
              <button 
                type="button"
                onClick={() => {
                  const updated = formData.childSafety.helplines.filter((_: any, i: number) => i !== idx);
                  setFormData({...formData, childSafety: {...formData.childSafety, helplines: updated}});
                }}
...
function FacilitiesFormFields({ formData, setFormData }: any) {
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-6">
      ...
      <div className="p-8 border border-gray-100 rounded-[2.5rem] space-y-8">
        ...
        <div className="space-y-8">
          {formData.facilities.list.sort((a: any,b: any) => (a.order||0) - (b.order||0)).map((facility: any) => (
            <div key={facility.id} className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 space-y-6 relative group/item">
              <button 
                type="button"
                onClick={() => {
                  const updated = formData.facilities.list.filter((f: any) => f.id !== facility.id);
                  setFormData({...formData, facilities: {...formData.facilities, list: updated}});
                }}
                    ...
                    <div className="flex gap-3">
                      <input 
                        ...
                        onChange={(e) => {
                          ...
                          const index = updated.findIndex((f: any) => f.id === facility.id);
