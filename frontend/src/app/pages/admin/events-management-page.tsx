...
export function EventsManagementPage() {
  ...
  const [isAdding, setIsAdding] = useState<EventDraft | null>(null);
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={(e) => {
                      ...
                      if (isAdding) setIsAdding({...isAdding, title: e.target.value});
                    }}
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={(e) => {
                      ...
                      if (isAdding) setIsAdding({...isAdding, date: e.target.value});
                    }}
                    className="w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl font-bold text-gray-800 focus:ring-2 focus:ring-[#1E3A8A]/20 outline-none"
                    required
                  />
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    onChange={(e) => {
                      ...
                      if (isAdding) setIsAdding({...isAdding, location: e.target.value});
                    }}
                    className="w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl font-bold text-gray-800 focus:ring-2 focus:ring-[#1E3A8A]/20 outline-none"
                  ...
                  <div className="flex gap-4">
                    <input 
                      ...
                      onChange={(e) => {
                        ...
                        if (isAdding) setIsAdding({...isAdding, image: e.target.value});
                      }}
                    ...
                    <MediaUploadButton
                      onSelect={(url) => {
                        ...
                        if (isAdding) setIsAdding({ ...isAdding, image: url });
                      }}
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  onChange={(e) => {
                    ...
                    if (isAdding) setIsAdding({...isAdding, description: e.target.value});
                  }}
                  rows={4}
